...
# 2. Verberg alle Streamlit branding & menu's (GitHub, Deploy, Footer)
hide_style = """
    <style>
...
if not os.path.exists(IMAGE_DIR):
    ...
    if len(all_photos) < 9:
        ...
        if len(b64_list) != 9:
            st.error("Fout bij laden foto's.")
            st.stop()
        ...
        <head>
            ...
            <style>
                ...
                .start-btn {{
                    ...
                    border-radius: 15px; font-weight: bold; box-shadow: 0 4px 10px rgba(0,0,0,0.1);
                }}
                .start-btn.silent {{ background: #757575; }}
                
                #game-container {{
                    display: none; flex-direction: column; align-items: center; width: 95vw; max-width: 400px;
                }}
                .grid {{ 
                ...
                .cross::before, .cross::after {{
                    content: ''; position: absolute; top: 50%; left: 10%; width: 80%; height: 12px; background: rgba(230, 0, 0, 0.8); border-radius: 5px;
                }}
                ...
                .instruction {{
                    color: #444; font-style: italic; font-size: 16px; text-align: center; padding: 10px; background: rgba(255,255,255,0.7); border-radius: 10px;
                }}
            </style>
        </head>
        <body>
            <div id="overlay">
                <h3 style="color: #333; margin-bottom: 20px;">Kies je modus:</h3>
            ...
            <div id="game-container">
                ...
                <div class="instruction">
                    💡 Klik op de foto als je die in Rietman verhaal ziet!
                </div>
            </div>
